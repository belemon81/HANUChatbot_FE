...
const ChatInterface = ({ clearChat, chatLog, isLoading, inputQuestion, setInputQuestion, handleSubmit, chatEnd }) => {
    return (
        <div className="h-screen flex">
            ...
            <div className="bg-gray-900 w-1/5 flex flex-col justify-center items-center">
                ...
                <div className="p-4">
                    <Link href="/education">
                        <div className="bg-slate-600 rounded-lg p-4 text-white cursor-pointer transition duration-300 hover:bg-gray-800 font-semibold mb-4">Educational Program</div>
                    </Link>
                    <Link href="/services">
                        <div className="bg-slate-600 rounded-lg p-4 text-white cursor-pointer transition duration-300 hover:bg-gray-800 font-semibold">Public Administration</div>
                    </Link>
                    <div className="mt-4">
